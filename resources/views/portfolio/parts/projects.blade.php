                ...
                <div class="col-lg-4 col-md-6 grid-item grid-sizer cat-three cat-one">
                    <div class="project__item-two">
                        ...
                        <div class="project__content-two">
                            <h2 class="title"><a
                                    href="{{ url("project-details/{$unit->id}") }}">{{ getLocalizedValueDashboard($unit, 'name') }}</a>
                            </h2>
                            <span>{{ \Carbon\Carbon::parse($unit->start_date)->format('F Y') }} -
                                {{ \Carbon\Carbon::parse($unit->end_date)->format('F Y') }}</span>
                        </div>
