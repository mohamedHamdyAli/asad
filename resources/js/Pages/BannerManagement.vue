          ...
          <div class="lg:col-span-4 space-y-2">
            ...
            <div class="border rounded-2xl p-4 bg-gray-50">
              <input
                ...
                accept="image/*"
                class="file-input"
                @change="e => onCreateFileChange(e, setFieldValue)"
              />
    ...
    <div class="p-3.5 space-y-3">
      ...
      <div class="grid grid-cols-2 gap-2">
        <div>
          ...
          <input
            v-model="editDraft[b.id].name.en"
        ...
        <div>
          ...
          <input
            v-model="editDraft[b.id].name.ar"
            class="w-full border rounded-lg px-2 py-1 text-xs"
            placeholder="AR name"
          />
        </div>
      ...
      <div class="grid grid-cols-2 gap-2">
        <div>
          ...
          <textarea
            v-model="editDraft[b.id].description.en"
            class="w-full border rounded-lg px-2 py-1 text-xs"
        ...
        <div>
          ...
          <textarea
            v-model="editDraft[b.id].description.ar"
            class="w-full border rounded-lg px-2 py-1 text-xs"
      ...
      <div class="space-y-2">
        ...
        />
        <button
          class="px-2 py-2 border rounded-xl text-xs hover:bg-gray-50 w-full"
...
/* Create: file change */
function onCreateFileChange(e, setFieldValue) {
  const file = e.target.files?.[0] ?? null
  if (!file) return

  // register value and validate immediately
