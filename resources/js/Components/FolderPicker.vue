...
async function createFolder() {
  ...
  try {
    ...
    emit('update:modelValue', created.id) // select immediately
    closeModal()
  } catch (e) {
...
<template>
  <div class="relative w-full">
    ...
    <button
      type="button"
      class="form-input flex justify-between items-center w-full"
      @click="toggle"
    >
      <span>
    ...
    >
      ...
      <!-- New folder -->
      <div
        class="px-3 py-2 text-sm text-green-600 hover:bg-gray-50 cursor-pointer border-t"
